...
package com.mobile_23rdaug.services.calculator.services;
import com.mobile_23rdaug.services.calculator.*;
...
public class CalculatorService{
	...
	public AddResponse add(  com.mobile_23rdaug.services.calculator.Add parameters )
	          {
 ...
 return calculatorsoap.add(parameters );
	...
	public DivideResponse divide(  com.mobile_23rdaug.services.calculator.Divide parameters )
	          {
 	    Calculator calculator = new Calculator();
 CalculatorSoap calculatorsoap = calculator.getCalculatorSoap();
 SoapSettingsResolver.setBindingProperties((BindingProvider)calculatorsoap, soapServiceSettings);
 return calculatorsoap.divide(parameters );
	...
	public MultiplyResponse multiply(  com.mobile_23rdaug.services.calculator.Multiply parameters )
	          {
 	    Calculator calculator = new Calculator();
 CalculatorSoap calculatorsoap = calculator.getCalculatorSoap();
 SoapSettingsResolver.setBindingProperties((BindingProvider)calculatorsoap, soapServiceSettings);
 return calculatorsoap.multiply(parameters );
	...
	public SubtractResponse subtract(  com.mobile_23rdaug.services.calculator.Subtract parameters )
	          {
 	    Calculator calculator = new Calculator();
 CalculatorSoap calculatorsoap = calculator.getCalculatorSoap();
 SoapSettingsResolver.setBindingProperties((BindingProvider)calculatorsoap, soapServiceSettings);
